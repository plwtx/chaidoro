const CODEBERG_URL = "https://codeberg.org/plwtx";
const GITHUB_URL = "https://github.com/plwtx/chaidoro";

const ICON_CLASS =
  "fill-brown-500/70 dark:fill-dark-100/40 hover:fill-brown-800 dark:hover:fill-dark-100 size-5 cursor-pointer stroke-0 transition-colors";
...
export default function RepoLinks() {
  return (
    <div className="flex items-center gap-4 px-3 pt-1 pb-3">
      ...
      >
        <svg className={ICON_CLASS} role="img" viewBox="0 0 24 24">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Chaidoro source on GitHub"
      >
        <svg className={ICON_CLASS} role="img" viewBox="0 0 24 24">
          <title>GitHub</title>
